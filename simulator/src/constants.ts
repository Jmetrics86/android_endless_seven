...
export const DARK_POOL: CardData[] = [
  ...
  },
  {
    ...
    "power": 3,
    "isChampion": false,
    "ability": "During the battle step, +4 Power. Flip: Place a -3 Weakness Marker on any creature with Power equal to or greater than this creature.",
    "hasTargetedAbility": true,
