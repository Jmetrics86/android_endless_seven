...
export const DARK_POOL: CardData[] = [
  ...
  { name: "Umbarax", faction: "Darkness", type: "Graveborn", power: 9, isChampion: true, ability: "Champion. Flip: Cannot be destroyed by battle this turn. After Umbarax destroys a creature in battle place a +2 Power marker on this creature for each Graveborn in play." },
  ...
  { name: "Valerius Nightshade", faction: "Vampyre", type: "Creature", power: 2, isChampion: false, ability: "Haste: Resolve battle before Flip abilities. Any creature battling this creature has its Flip ability Nullified.", hasHaste: true },
